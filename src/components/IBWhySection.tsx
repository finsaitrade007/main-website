...
const tabs = [
  ...
  },
  {
    ...
    desc: "We provide clear and honest reporting on all your referrals, trades, and commissions — no hidden fees, no surprises.",
  },
  {
    label: "Attractive Rebates",
    title: "Earn competitive rebates on every trade your clients make.",
    desc: "Our rebate structure is designed to maximize your earnings with every referral, giving you a reliable and growing income stream.",
  },
  {
    label: "Competitive Tools",
    title: "Access powerful tools to grow your partner network.",
    desc: "From marketing materials to real-time dashboards, we equip you with everything you need to succeed as an introducing broker.",
  },
];

export default function IBWhySection() {
      ...
      <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          <h2 className="section-title" style={{ marginBottom: "16px" }}>
            Why Become an IB with Finsai Trade?
          </h2>
          <p className="section-desc">
            Smart, secure, and reliable trading for everyone, everywhere.
          </p>
        </div>
