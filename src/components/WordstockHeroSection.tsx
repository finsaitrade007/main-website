...
/* Figma hero stat icons (tabler_clock, mdi_accounts-outline, ri_swap-line).
 * Gradient ids namespaced per component. */

function BlueChipIcon() {
  return (
    <svg aria-hidden focusable="false" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4.29926 18.0182C3.77159 16.7443 3.5 15.3789 3.5 14C3.5 11.2152 4.60625 8.54451 6.57538 6.57538C8.54451 4.60625 11.2152 3.5 14 3.5C16.7848 3.5 19.4555 4.60625 21.4246 6.57538C23.3938 8.54451 24.5 11.2152 24.5 14C24.5 15.3789 24.2284 16.7443 23.7007 18.0182C23.1731 19.2921 22.3996 20.4496 21.4246 21.4246C20.4496 22.3996 19.2921 23.1731 18.0182 23.7007C16.7443 24.2284 15.3789 24.5 14 24.5C12.6211 24.5 11.2557 24.2284 9.98182 23.7007C8.70791 23.1731 7.55039 22.3996 6.57538 21.4246C5.60036 20.4496 4.82694 19.2921 4.29926 18.0182Z" stroke="url(#bluechipicon-paint0_linear_571_193)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M14 8.16669V14L17.5 17.5" stroke="url(#bluechipicon-paint1_linear_571_193)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
<defs>
<linearGradient id="bluechipicon-paint0_linear_571_193" x1="32.0923" y1="11.2143" x2="3.48244" y2="11.3983" gradientUnits="userSpaceOnUse">
<stop stopColor="#7DB9D6"/>
<stop offset="1" stopColor="#056FB4"/>
</linearGradient>
<linearGradient id="bluechipicon-paint1_linear_571_193" x1="18.7654" y1="11.5953" x2="13.9969" y2="11.6068" gradientUnits="userSpaceOnUse">
<stop stopColor="#7DB9D6"/>
<stop offset="1" stopColor="#056FB4"/>
</linearGradient>
</defs>
...
export default function WordstockHeroSection() {
  return (
    ...
    >
      {/*
        Panel aspect must match the source image (2112x1587 = 1.3308), otherwise
        objectFit:cover crops ~12% off the top and bottom — which is what was
        cutting the artwork. 760x571 = 1.3310. Flush right (680+760=1440) and
        bottom (149+571=720).
      */}
      <div
